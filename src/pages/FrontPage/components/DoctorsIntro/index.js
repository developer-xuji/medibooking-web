...
const DoctorsIntro = () => {
    ...
    return <Layout>
        ...
        <TextIntro>
            ...
            <Description>With over 170 Doctors, we’ll help find the right one for you and your family.</Description>
            <button><a href={getRoutePath("doctors")}>View All  →</a></button>
        </TextIntro>
    </Layout>
}
