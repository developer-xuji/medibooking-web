...
const Gallary = () => {
  return (
    <Layout>
      <LeftGallary>
        <img alt="doctor" src={DOC1_PIC}></img>
        <img alt="doctor" src={DOC2_PIC}></img>
        <img alt="doctor" src={DOC3_PIC}></img>
        <img alt="doctor" src={DOC4_PIC}></img>
      </LeftGallary>
      <RightGallary>
        <img alt="doctor" src={DOC5_PIC}></img>
        <span> 170+ </span>
      </RightGallary>
    </Layout>
  );
